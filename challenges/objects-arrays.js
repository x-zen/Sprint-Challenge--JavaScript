...
console.log(animalNames);	console.log(animalNames);
...
let lowerCase = zooAnimals.map(function(zooAnimal, index, zooAnimals) {
...
console.log(largerPopulation);	console.log(largerPopulation);
